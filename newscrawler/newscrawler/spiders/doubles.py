...
## Scraping plus précis, exemple d'adresse : https://www.atptour.com/en/rankings/doubles?rankDate=2021-02-01&rankRange=0-100&countryCode=COL

class DoublesSpider(scrapy.Spider):
    name = 'doubles'
    allowed_domains = ['www.atptour.com/en/rankings/doubles']
    start_urls = ['https://www.atptour.com/en/rankings/doubles/']
    user_agent = ""
    custom_settings = {
        'FEED_FORMAT': 'json',
        'FEED_URI':'data/doubles.json'
    }
